...
const FOFScreen = () => {
  ...
  // Added 'FOF' to category options
  const categoryOptions = ['FOF'];
    ...
    const fetchSchemes = async (house, category) => {
      ...
      try {
        const categoryMap = {
          ...
          'FOF': 'fof',  // Support for FOF category
        };
        ...
        const response = await fetch(`${API_BASE_URL}/buySell/getAllFundHouseSchemeNames.php`, {
          ...
          body: JSON.stringify({
            ...
            setFundRouter: 'Fof', // Assuming backend expects this string
          }),
        });
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Invest Now - Fund of Funds</Text>
