...
const ETFScreen = () => {
  ...
  // Check if amount is valid and positive number
  const isAmountValid = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Invest Now - ETFs</Text>
              ...
              <View style={styles.buttonRow}>
                <TouchableOpacity
                  style={[
                    styles.actionButton,
                    styles.buyButton,
                    !isAmountValid() && { backgroundColor: '#a5d6a7' },
                  ]}
                ...
                <TouchableOpacity
                  style={[
                    styles.actionButton,
                    styles.sipButton,
                    !isAmountValid() && { backgroundColor: '#90a4e5' },
                  ]}
                  onPress={() =>
